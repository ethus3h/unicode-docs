...
The Unicode Standard, Version 6.3 - Code Charts

The file "CodeCharts.pdf" contains all of the code charts for
Unicode 6.3. Warning: this file is large (96,351,733 bytes). The charts
in CodeCharts.pdf do not highlight the new characters.
...
terms of use for the Unicode website or the Unicode Character Database.

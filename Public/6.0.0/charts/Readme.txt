...
The Unicode Standard, Version 6.0 - Code Charts

The file "CodeCharts.pdf" contains all of the code charts for
Unicode 6.0. Warning: this is a 75 megabyte file. This file does not
highlight the new characters. 

The file "RSIndex.pdf" is the complete Unihan Radical Stroke Index.  

These files are stable. They will not be updated with errata, or
when additional characters are assigned to the Unicode Standard. See
http://www.unicode.org/charts/ for access to a complete list of the
latest character code charts. See http://www.unicode.org/charts/PDF/Unicode-6.0/
for charts showing only the characters added in Unicode 6.0. Both of
these locations provide access to multiple files for convenient on-line
viewing of individual code tables.
